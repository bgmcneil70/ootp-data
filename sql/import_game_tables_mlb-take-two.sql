...
\copy games FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/games.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
...
SELECT
    ...
    attendance,
    date::date,
    to_timestamp(concat_ws(' ',date::varchar,to_char(CASE WHEN mod(time,100) >= 60 THEN time - mod(time,100) + 100 + mod(time,100) - 60 ELSE time END,'0000')),'YYYY-MM-DD HH24MI'),
    game_type,
    played::boolean,
    innings,
    runs0,
...
\copy players_game_batting_stats FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/players_game_batting.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
...
\copy games_score FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/games_score.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
...
\copy projected_starting_pitchers FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/projected_starting_pitchers.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
