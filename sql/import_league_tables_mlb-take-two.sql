...
\copy league_events FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/league_events.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
...
\copy league_playoffs FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/league_playoffs.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
...
\copy league_history FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/league_history.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
...
\copy league_injuries FROM '/Users/brianmcneil/Documents/Personal/ootp_stuff/ootp_sql/csv/mlb-take-two/league_injuries.csv' DELIMITER ',' CSV HEADER encoding 'ISO-8859-1';
...
\copy league_news FROM '/Users/brianmcneil/Documents/Personal/ootp_stuff/ootp_sql/csv/mlb-take-two/league_news.csv' DELIMITER ',' CSV HEADER encoding 'ISO-8859-1';

INSERT INTO league.league_news (season, league_id,news_date, news_id, team_id, player_id, news_text, news_seq_num)
SELECT
    l3.season, l3.league_id,l3.news_date, l3.news_id, l3.team_id, l3.player_id, l3.news_text,row_number() over (partition by season,news_date,team_id)
FROM (
         SELECT
             season,
             league_id,
...
ON CONFLICT (season,league_id,news_date,news_id) DO NOTHING
    ;
...
\copy league_transactions FROM '/Users/brianmcneil/Documents/Personal/ootp_stuff/ootp_sql/csv/mlb-take-two/league_transactions.csv' DELIMITER ',' CSV HEADER encoding 'ISO-8859-1';
...
\copy league_playoff_fixtures FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/league_playoff_fixtures.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
...
\copy league_history_all_star FROM '/Users/brianmcneil/Library/Containers/com.ootpdevelopments.ootp26macqlm/Data/Application Support/Out of the Park Developments/OOTP Baseball 26/saved_games/mlb-take-two.lg/import_export/csv/league_history_all_star.csv' DELIMITER ',' NULL AS 'NULL' CSV HEADER encoding 'UTF-8';
